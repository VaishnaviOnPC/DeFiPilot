  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="flex justify-end p-6">
        ...
        >
          {/* White Circle Badge for Dark Background */}
          <div className="bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-black rounded-full flex items-center justify-center">
                <span className="text-white text-sm font-bold">⚡</span>
              </div>
              <span className="text-black font-semibold text-sm">bolt.new</span>
            </div>
          </div>
          
          {/* Hover tooltip */}
          <div className="absolute top-full right-0 mt-2 px-3 py-1 bg-black/80 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
            Built with Bolt.new
          </div>
        </a>
      </header>
